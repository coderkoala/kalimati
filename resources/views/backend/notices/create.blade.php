...
@section('title', __('Create a new Notice/Publication'))

@section('content')
    <x-forms.post :action="route('admin.notices.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create a new Notice/Publication')
            </x-slot>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group">
                                ...
                                <input id="file" class="form-control" type="text" name="url" readonly>
                            </div>
                        </div>
                    </div>
                </div>
