...
@section('title', __('Create New Price Log'))

@section('content')
    <x-forms.post :action="route('admin.pricelog.store')">
        <x-backend.card>
            <x-slot name="header">
                @lang('Create New Price Log')
            </x-slot>

            <x-slot name="headerActions">
                <x-utils.link class="card-header-action" :href="asset('/import/Import-Template-Price.xlsx')" :text="__('Download Excel Import Template File')" />
            ...
            <x-slot name="body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select name="price_type" class="form-control" required="required">
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Create New Price Log')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
