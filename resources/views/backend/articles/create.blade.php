...
@section('content')
    <x-forms.post :action="route('admin.articles.store')">
        <x-backend.card>
            <x-slot name="header">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="input-group">
                                ...
                                <input id="file" class="form-control" type="text" name="article_image" value="{{ asset('img/slide1.jpg') }}" readonly>
                            </div>
                            <div id="holder" style="margin-top:15px;max-height:100px;">
                            <img style="height: 5rem" src="{{ asset('img/slide1.jpg') }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <x-slot name="footer">
                <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Create New Article')</button>
            </x-slot>
        </x-backend.card>
    </x-forms.post>
@endsection
