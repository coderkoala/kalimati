            ...
            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <input id="datePricing" name="datePricing"
                                                    ...
                                                    placeholder="{{ __('Date for price information') }}" type="date">
                                            </div>
                                            <div class="col-sm-3">
                                                <button type="submit"
                ...
                <div class="col-md-12">
                    <div class="project-detail">
                        <h4 class="bottom-head">{{ __('Daily Price Information') }}
                            {{ isset($date) ? " - $date" : '' }}</h4>
                        <div class="pro-info">
                                ...
                                <tbody>
                                    @foreach (App\Models\commodityPriceDaily::getPrice(isset($paramDate) ? $paramDate : null) as $index => $value)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $currency . __idf($value->minprice) }}</td>
                                            <td>{{ $currency . __idf($value->maxprice) }}</td>
