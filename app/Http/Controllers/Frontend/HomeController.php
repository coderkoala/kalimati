...
class HomeController extends Controller
{
    ...
    public function checkArrivals()
    {
        ...
        return view('frontend.singleDayArrivals', ['date' => $date]);
    }
    ...
    public function checkArrivalsPOST(Request $request)
    {
        ...
        return view('frontend.singleDayArrivals', [
            'date'      => $date,
    ...
    public function checkDailyPrices()
    {
        ...
        return view('frontend.singleDayPricings', ['date' => $date]);
    }
    ...
    public function checkDailyPricesPOST(Request $request)
    {
        ...
        return view('frontend.singleDayPricings', [
            'date'      => $date,
            'paramDate' => $dateRequested,
        ]);
    }
